  ...
  Treemap.generate = (function() {
      ...
      this.getCoordinates = function(a) {
        ...
        if (this.width >= this.height)
          for (d = 0; d < a.length; d++)
            b.push([c, f, c + m, f + a[d] / m]), f += a[d] / m;
        else
          for (d = 0; d < a.length; d++)
            b.push([c, f, c + a[d] / e, f + e]), c += a[d] / e;
        return b;
      };
      this.cutArea = function(a) {
        this.width >= this.height
          ? (a /= this.height, a = new q(
              this.xoffset + a,
              this.yoffset,
              this.width - a,
              this.height
            ))
          : (a /= this.width, a = new q(
              this.xoffset,
              this.yoffset + a,
              this.width,
              this.height - a
    ...
    function r(a, b, c, e, h) {
      ...
      if (a[0] && a[0].constructor === Array) {
        ...
        for (f = 0; f < a.length; f++)
          i.push(
            r(a[f], b[f][2] - b[f][0], b[f][3] - b[f][1], b[f][0], b[f][1])
          );
      } else
        i = g(a, b, c, e, h);
      return i;
    ...
    function d(a, b, c, e) {
      ...
      if (0 === a.length)
        ...
        0 === b.length
          ? i = !0
          : (f = b.slice(), f.push(p), i = j(b, h), h = j(f, h), i = i >= h);
        i
          ? (b.push(p), d(a.slice(1), b, c, e))
          : (p = c.cutArea(l(b), e), e.push(c.getCoordinates(b)), d(
              a,
              [],
              p,
              e
    ...
    function j(a, b) {
      ...
      return Math.max(
        Math.pow(b, 2) * d / Math.pow(h, 2),
        Math.pow(h, 2) / (Math.pow(b, 2) * c)
      );
    }
    function l(a) {
      var b = 0, c;
...
(function() {
  Treemap.draw = (function() {
    function q(g, d) {
      for (var j in d)
        d.hasOwnProperty(j) && (g[j] = d[j]);
      return g;
    }
    function r(g, d, j, l, k) {
      var a, b, c;
      if (d[0][0] && d[0][0].constructor === Array)
        for (a = 0; a < d.length; a++)
          b = k.slice(), b.push(a), r(g, d[a], j, l, b);
      else
        for (a = 0; a < d.length; a++) {
          b = k.slice();
          b.push(a);
    ...
    return function(g, d, j, l, k, a) {
      ...
      e = (function() {
        return function(d, e, i) {
          ...
          k = a.label && a.label.constructor === Function
            ? a.label(d, i)
            : a.label;
          k = q(c(d, i), k);
          e.attr(k);
      ...
      a.label = "undefined" === typeof a.label ? {} : a.label;
